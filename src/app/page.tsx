  ...
  return (
    <SiteThemeProvider theme={{ styleVariant: "funAndTrendy", colorTemplate: 1, textAnimation: "slide" }}>
      <div id="nav" data-section="nav">
        <NavbarLayoutFloatingOverlay logoSrc="/images/logo.svg" navItems={navItems} buttonText="Buy Meme" onButtonClick={() => {}} />
      </div>
      ...
      <div id="footer" data-section="footer">
        <FooterLogo logoSrc="/images/logo.svg" logoText="MemePulse" className="footer-class" svgClassName="footer-logo-class" />
      </div>
    </SiteThemeProvider>
  );
}